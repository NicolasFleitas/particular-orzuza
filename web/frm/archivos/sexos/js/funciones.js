    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            if (json.nuevo === "true") {
                ...
                siguienteCampo("#nombre_sexo", "#botonAgregar", true);
            } else {
                $("#botonAgregar").prop('disabled', true);
                $("#botonModificar").prop('disabled', false);
                $("#botonEliminar").prop('disabled', true);
                siguienteCampo("#nombre_sexo", "#botonModificar", true);
            }
        },
        error: function (e) {
            $("#mensajes").html("No se pudo modificar los datos.");
...
function validarFormulario() {
    var valor = true;
    if ($("#nombre_sexo").val().trim() === "") {
        valor = false;
        $("#mensajes").html("Escriba el nombre del sexo por favor");
        $("#nombre_sexo").focus();
    }
    return valor;
}